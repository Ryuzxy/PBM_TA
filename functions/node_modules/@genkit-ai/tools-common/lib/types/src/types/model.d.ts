import { z } from 'zod';
import { CustomPartSchema, DataPartSchema, MediaPartSchema, MultipartToolResponseSchema, Part, PartSchema, ReasoningPartSchema, ResourcePartSchema, TextPartSchema, ToolRequestPartSchema, ToolResponsePartSchema, type CustomPart, type DataPart, type MediaPart, type MultipartToolResponse, type ReasoningPart, type ResourcePart, type TextPart, type ToolRequestPart, type ToolResponsePart } from './parts';
export { CustomPartSchema, DataPartSchema, MediaPartSchema, MultipartToolResponseSchema, Part, PartSchema, ReasoningPartSchema, ResourcePartSchema, TextPartSchema, ToolRequestPartSchema, ToolResponsePartSchema, type CustomPart, type DataPart, type MediaPart, type MultipartToolResponse, type ReasoningPart, type ResourcePart, type TextPart, type ToolRequestPart, type ToolResponsePart, };
...
export declare const GenerationCommonConfigDescriptions: {
    temperature: string;
