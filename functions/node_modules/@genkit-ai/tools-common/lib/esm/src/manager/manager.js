...
export class BaseRuntimeManager {
    telemetryServerUrl;
    projectRoot;
    processManager;
...
export class RuntimeManager extends BaseRuntimeManager {
    ...
    async listValues(input) {
        ...
        try {
            const response = await axios.get(`${runtime.reflectionServerUrl}/api/values`, {
                params: {
                    type: input.type,
                },
            });
            ...
            if (err.response?.status === 404) {
                ...
                throw new GenkitToolsError(`Bad request: ${err.response?.data}`);
            }
