...
exports.GenerateActionOptionsSchema = exports.GenerateActionOutputConfig = exports.GenerateResponseChunkSchema = exports.ModelResponseChunkSchema = exports.GenerateResponseSchema = exports.ModelResponseSchema = exports.CandidateErrorSchema = exports.CandidateSchema = exports.FinishReasonSchema = exports.GenerationUsageSchema = exports.GenerateRequestSchema = exports.ModelRequestSchema = exports.OutputConfigSchema = exports.GenerationCommonConfigSchema = exports.GenerationCommonConfigDescriptions = exports.ToolDefinitionSchema = exports.ModelInfoSchema = exports.MessageSchema = exports.RoleSchema = exports.OperationSchema = exports.ModelReferenceSchema = exports.ToolResponsePartSchema = exports.ToolRequestPartSchema = exports.TextPartSchema = exports.ResourcePartSchema = exports.ReasoningPartSchema = exports.PartSchema = exports.MultipartToolResponseSchema = exports.MediaPartSchema = exports.DataPartSchema = exports.CustomPartSchema = void 0;
...
exports.ModelReferenceSchema = zod_1.z.object({
    name: zod_1.z.string(),
...
exports.GenerationCommonConfigDescriptions = {
    temperature: 'Controls the degree of randomness in token selection. A lower value is ' +
    ...
    topP: 'Decides how many possible words to consider. A higher value means ' +
        'that the model looks at more possible words, even the less likely ' +
        'ones, which makes the generated text more diverse.',
};
exports.GenerationCommonConfigSchema = zod_1.z
    .object({
    version: zod_1.z
        .string()
        .describe('A specific version of a model family, e.g. `gemini-2.5-flash` ' +
        'for the `googleai` family.')
        .optional(),
    temperature: zod_1.z
        .number()
        .describe(exports.GenerationCommonConfigDescriptions.temperature)
        .optional(),
    maxOutputTokens: zod_1.z
        .number()
        .describe(exports.GenerationCommonConfigDescriptions.maxOutputTokens)
        .optional(),
    topK: zod_1.z
        .number()
        .describe(exports.GenerationCommonConfigDescriptions.topK)
        .optional(),
    topP: zod_1.z
        .number()
        .describe(exports.GenerationCommonConfigDescriptions.topP)
        .optional(),
    stopSequences: zod_1.z
        .array(zod_1.z.string())
        .describe('Set of character sequences (up to 5) that will stop output generation.')
        .optional(),
    apiKey: zod_1.z
        .string()
        .describe('API Key to use for the model call, overrides API key provided in plugin config.')
        .optional(),
})
    .passthrough();
