...
exports.RunActionResponseSchema = exports.ActionMetadataSchema = exports.ActionSchema = exports.JSONSchema7Schema = exports.CustomAnySchema = exports.SingularAnySchema = void 0;
...
exports.ActionSchema = zod_1.z
    ...
    .openapi('Action');
exports.ActionMetadataSchema = zod_1.z
    .object({
    ...
    inputJsonSchema: exports.JSONSchema7Schema.optional(),
    outputSchema: zod_1.z.unknown().optional(),
    outputJsonSchema: exports.JSONSchema7Schema.optional(),
    streamSchema: zod_1.z.unknown().optional(),
    metadata: zod_1.z.record(zod_1.z.string(), exports.CustomAnySchema).optional(),
})
