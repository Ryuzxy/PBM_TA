...
exports.evalRun = new commander_1.Command('eval:run')
    ...
    if (dashDashIndex !== -1) {
        ...
        runtimeCommand = exports.evalRun.args.slice(-numArgsAfterDashDash);
        const commandArgs = exports.evalRun.args.slice(0, exports.evalRun.args.length - numArgsAfterDashDash);
    ...
    const runAction = async (manager) => {
        ...
        const evalDataset = await (0, utils_1.loadEvaluationDatasetFile)(actualDataset);
