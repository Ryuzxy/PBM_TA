...
exports.evalFlow = new commander_1.Command('eval:flow')
    ...
    if (dashDashIndex !== -1) {
        ...
        runtimeCommand = exports.evalFlow.args.slice(-numArgsAfterDashDash);
        const commandArgs = exports.evalFlow.args.slice(0, exports.evalFlow.args.length - numArgsAfterDashDash);
    ...
    const runAction = async (manager) => {
        ...
        const inferenceDataset = await readInputs(sourceType, actualData, options.input);
        ...
        if (toolsInfo) {
            ...
            utils_1.logger.info(`${clc.cyan('Evaluation ID:')} ${evalRun.key.evalRunId}`);
        }
    };
