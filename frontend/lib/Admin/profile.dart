  ...
  Future<String?> _uploadPhoto(String uid) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to upload to Cloudinary. Status Code: ${response.statusCode}');
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context)
  ...
  Future<void> _handleLogout() async {
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        title: const Text('Logout / Switch User'),
              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 20),
                      Divider(color: subTextColor.withOpacity(0.2), thickness: 0.5),
                      const SizedBox(height: 20),
                      ...
                      CSCPicker(
                        ...
                        dropdownDecoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                            color: cardColor,
                            border: Border.all(color: subTextColor.withOpacity(0.3), width: 1)),
  ...
  Widget _buildTextField({
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        filled: true,
        fillColor: readOnly ? subTextColor.withOpacity(0.06) : cardColor,
        ...
        focusedBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(
            color: readOnly ? subTextColor.withOpacity(0.3) : accentColor,
